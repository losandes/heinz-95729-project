...
const { parse: parse$3 } = require$$8__default;
function lead(x) {
...
const serveIndex = (req, res) => {
  ...
  res.end('<!doctype html>\n<html lang="en">\n  <head>\n    <meta charset="UTF-8" />\n    <link rel="icon" type="image/svg+xml" href="/vite.svg" />\n    <meta name="viewport" content="width=device-width, initial-scale=1.0" />\n    <title>Heinz 95729</title>\n    <script type="module" crossorigin src="/assets/index-212bd072.js"><\/script>\n    <link rel="stylesheet" href="/assets/index-23e40244.css">\n  </head>\n  <body>\n    <div id="root"></div>\n    \n  </body>\n</html>\n');
};
...
function viaLocal(dir, isEtag, uri, extns) {
  ...
  for (; i < arr.length; i++) {
    ...
    if (abs.startsWith(dir) && require$$1.existsSync(abs)) {
      stats = require$$1.statSync(abs);
...
function send(req, res, file, stats, headers) {
  ...
  require$$1.createReadStream(file, opts).pipe(res);
}
const ENCODING = {
  ".br": "br",
  ".gz": "gzip"
...
const server = polka();
server.use(sirv("dist/production"));
applyHandler(server);
