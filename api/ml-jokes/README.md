...
This content-based filtering approach consists in predicting each user <img src="https://latex.codecogs.com/gif.latex?$i$" title="$i$" /> gave to each joke $j$, using two types of features:
