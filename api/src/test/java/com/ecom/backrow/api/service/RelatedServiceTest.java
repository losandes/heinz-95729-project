...
public class RelatedServiceTest {
    ...
    @InjectMocks
    private RelatedItemsService relatedService;

    @Mock
    private ProductService productService;

    @Mock
    private RelateItemsDao relatedDao;
    ...
    @Test
    public void suggestionOfProductIdTest() {

        String productId = "productId";
        when(productService.getProductsByProductId(productId)).thenReturn(new Product());
        List<String> result = relatedService.getSuggestionsByProductId(productId);
