...
urlpatterns = [
    ...
    # OAuth Domain
    path('store/google/login', AuthViews.google_login, name='store_google_login'),
    path('store/google/login/callback', AuthViews.login_callback, name='store_login_callback'),
    path('store/reddit/login', AuthViews.reddit_login, name='store_reddit_login'),
    path('store/reddit/login/callback', AuthViews.login_callback, name='store_login_callback'),
    path('store/github/login', AuthViews.github_login, name='store_github_login'),
    path('store/github/login/callback', AuthViews.login_callback, name='store_login_callback'),
